...
public enum LogMessage {
    ...
    ADD_FILM("POST: Получен запрос на добавление фильма"),
    ADD_USER("POST: Получен запрос на добавление пользователя"),
    ...
    GET_POPULAR("GET: Получен запрос на получение списка популярных фильмов в количесвте = "),
    ADD_FRIEND("POST: Получен запрос на добавление друга с id = "),
    ADD_FRIEND_DONE("Друг добавлен"),
    DEL_FRIEND("DELETE: Получен запрос на удаление друга с id = "),
    DEL_FRIEND_DONE("Друг удален"),
    GET_FRIENDS("GET: Получен запрос на получение друзей пользователя с id = "),
    GET_COMMON_FRIENDS("GET: Получен запрос на получение общих друзей пользователей с id "),
